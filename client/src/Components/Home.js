			...
			<div className="home_bottom">
				...
				<div className="home_content">
					...
					<p>
						...
						of an image.<br/> Figma image tricks and trips. Design well Figma image
						overlay can come in handy when trying <br/>to put text on top of an
						image. Figma image tricks and trips. Design well ...
					</p>
				</div>
