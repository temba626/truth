...
# user1 = User.create(name: "chris", email: "example@gmail.com", username: "Kpine", status: 1, cohort: "ab25", password: "1234", password_confirmation: "1234", image_url: "https://images.pexels.com/photos/2095582/pexels-photo-2095582.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1")

# user2 = User.create(name: "pine", email: "example2@gmail.com", username: "pine", status: 1, cohort: "ab25", password: "1234", password_confirmation: "1234", image_url: "https://images.pexels.com/photos/2146722/pexels-photo-2146722.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1")
